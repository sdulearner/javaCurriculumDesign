...
public class Socket_File extends Thread
{
    ...
    private JDBC_Photos jdbc_photos = new JDBC_Photos();
            ...
            if (reader.readLine().equals("photo"))//发图片
            {
                ...
                switch (flag)
                {
                    case '1'://上传图片
                    {
                        ...
                        String filePath = "D:/课设专用存图片/" + fileName;
                        try
                        {
                            try
                            {
                    ...
                    case '2'://下载图片
                    {
                        ...
                        try
                        {
                            try
                            {
                                File file = new File("D:/课设专用存图片/" + jdbc_documents.query(no).getName()); //要传输的文件路径
                                long l = file.length();
